...
Vars<3> Iapws95Thermo::updateThermo(const Primitive& data, const PrimitiveThermoVar& thermoData) const
{
...
void Iapws95Thermo::updateThermo(ComponentThermoVar& thermoData) const
{
